...
<section>
    ...
    <!-- Success message content -->
            ...
            <a href="{{ route('paket.create') }}" class="btn btn-outline-success">Tambah Data</a>
            <a href="{{ route('paket.pdf') }}" class="btn btn-outline-success">Unduh</a>
                    ...
                    <thead class="table-purple table-light">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; vertical-align: middle;">Rp {{ number_format($paket->harga_produk, 0, ',', '.') }}</td>
